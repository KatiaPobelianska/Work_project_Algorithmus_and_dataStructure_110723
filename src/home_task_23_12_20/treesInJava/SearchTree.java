package home_task_23_12_20.treesInJava;
...
//    ================================
    ...
    private boolean isBalanced(Node current) {
        ...
        if (Math.abs(leftHeight - rightHeight) <= 1 && isBalanced(current.left) && isBalanced(current.right)) {
            return true;
        }
    ...
    public static void main(String[] args) {
        ...
        // Добавим несколько элементов для создания несбалансированного дерева
        tree.add("E", 50);
        tree.add("F", 60);

        System.out.println("Is the tree balanced now? " + tree.isBalanced());
    }
